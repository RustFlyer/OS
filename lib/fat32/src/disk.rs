...
pub struct DiskCursor {
    pub sector: u64,
    pub offset: usize,
    pub blk_dev: Arc<dyn BlockDevice>,
}
...
impl fatfs::Read for DiskCursor {
    fn read(&mut self, buf: &mut [u8]) -> Result<usize, Self::Error> {
        ...
        let read_size = if self.offset != 0 || buf.len() < 512 {
            ...
            self.blk_dev.read(self.sector as usize, &mut data);
...
impl fatfs::Write for DiskCursor {
    fn write(&mut self, buf: &[u8]) -> Result<usize, Self::Error> {
        ...
        let write_size = if self.offset != 0 || buf.len() < 512 {
            ...
            self.blk_dev.write(self.sector as usize, &mut data);
            ...
            self.blk_dev.write(self.sector as usize, &data);
            512
        };
