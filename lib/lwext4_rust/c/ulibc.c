...
__attribute__((weak)) char *__stpcpy(char *restrict d, const char *restrict s)
{
#ifdef __GNUC__
...
__attribute__((weak)) int fflush(FILE *f)
{
...
__attribute__((weak)) void qsort_r(void *base,
                                   size_t nel,
                                   size_t width,
...
__attribute__((weak)) void qsort(void *base,
                                 size_t nel,
                                 size_t width,
                                 __compar_fn_t comp)
{
