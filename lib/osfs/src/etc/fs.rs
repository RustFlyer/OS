...
use crate::{
    etc::superblock::EtcSuperBlock,
    simple::{dentry::SimpleDentry, inode::SimpleInode},
};

pub struct EtcFsType {
...
impl EtcFsType {
    pub fn new() -> Arc<Self> {
        Arc::new(Self {
            meta: FileSystemTypeMeta::new("etcfs"),
        })
    }
}

impl FileSystemType for EtcFsType {
    ...
    fn base_mount(
        ...
        let sb = EtcSuperBlock::new(dev, self.clone());
