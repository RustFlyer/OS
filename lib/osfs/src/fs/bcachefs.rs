...
impl FileSystemType for BcacheFsType {
    ...
    fn base_mount(
        ...
        let sb = BcacheSuperBlock::new(dev, self.clone());
...
struct BcacheSuperBlock {
    meta: SuperBlockMeta,
}

impl BcacheSuperBlock {
    pub fn new(
        device: Option<Arc<dyn BlockDevice>>,
        fs_type: Arc<dyn FileSystemType>,
    ) -> Arc<Self> {
        Arc::new(Self {
            meta: SuperBlockMeta::new(device, fs_type, 3),
        })
    }
}

impl SuperBlock for BcacheSuperBlock {
