...
impl FileSystemType for BtrFsType {
    ...
    fn base_mount(
        ...
        let sb = BtrSuperBlock::new(dev, self.clone());
...
impl BtrSuperBlock {
    pub fn new(
        ...
        Arc::new(Self {
            meta: SuperBlockMeta::new(device, fs_type, 4),
        })
    }
}

impl SuperBlock for BtrSuperBlock {
